...
### App is Live on (UI)
    - https://mediamedia-player-by-suhailplayer-ui.netlify.app/

## screenshots
- ### main.cjs
![main.cjs](./screenshots/main.cjs.png)
- ### package.json
![package.json](./screenshots/package.json.png)
- ### allAPIs.js
![allAPIs.js](./screenshots/allAPIs.png)
- ### Workflow for generating .exe in release
